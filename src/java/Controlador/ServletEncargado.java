...
public class ServletEncargado extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
		...
		try{
			...
			if(registrar.RegistrarEncargada(id_empleado, nombre, apellido_paterno, apellido_materno,clinica,turno)){
                              validacion="Registro Exitoso";
                            request.getSession().setAttribute("validar", validacion);
                            response.sendRedirect("Coordinadora/AgregarEncargadaClinica.jsp");
			}
                        if(registrar.RegistrarUsuario(id_empleado, 2, usuario, contraseña));
