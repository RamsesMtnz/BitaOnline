<%-- 
    ...
    Created on : 8/05/2017, 03:42:25 PM
    Author     : Sammy Guergachi <sguergachi at gmail.com>
--%>

<%@page import="DTO.MaestroDTO"%>
...
<section class="content">
      <div class="row">
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Eliminar Docente</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
		...
		List<MaestroDTO> detalles = ConsultasMySQL.MostrarMaestros();
		for(int i=0; i<detalles.size();i++){
		%>
                                    <tr class="odd gradeX">
                                       <td><%=detalles.get(i).getId_empleado()%></td>
                                        <td><%=detalles.get(i).getNombreCompleto()%></td>
                                       
                                        <td><%=detalles.get(i).getCorreo()%></td>
                                  <td><a href="MetodoEliminarMaestro.jsp?id_empleado=<%=detalles.get(i).getId_empleado()%>" >Eliminar Docente</a></td>
