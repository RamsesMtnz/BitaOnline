<%-- 
    Document   : EliminarEncargada
    Created on : 8/05/2017, 08:35:31 PM
...
<html>
  ...
  <title>Quitar Encargado de Clinica</title>
                 ...
                 <tbody>
                                    <%
                                        ...
                                        <tr class="odd gradeX">
                                            ...
                                            <td><a href="MetodoEliminarE.jsp?id_empleado=<%=detalles.get(i).getId_empleado()%>" >Eliminar Encargada</a></td>
