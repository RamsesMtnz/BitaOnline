<%-- 
    ...
    Created on : 9/05/2017, 02:25:58 PM
...
<div class="box box-warning">
            <div class="box-header with-border">
              <h3 class="box-title">Generar Reporte De Alumnos Destacados</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
               <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                           <form action="../reporteAlumno.jsp" method="post">
                          <h5>   Generar Reporte De Los Alumnos Más Destacados De Acuerdo Al Semestre</h5>
                             <div class="row">
